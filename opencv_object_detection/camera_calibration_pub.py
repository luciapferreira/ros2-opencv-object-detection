...
class CameraCalibrationPub(Node):
    ...
    def __init__(self):
        ...
        calibration_path = os.path.join(
            ament_index_python.get_package_share_directory('opencv_object_detection'), 'calibration','ost.yaml')
        ...
        while rclpy.ok():
            image_path = os.path.join(
                ament_index_python.get_package_share_directory("opencv_object_detection"), 'calibration', 'images', f'{img_idx}.jpeg')
